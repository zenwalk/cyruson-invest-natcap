...
try:
    ...
    try:
        ...
        for i in range(0,len(dirList)):
            gp.Reclassify_sa(fetchpath+"\\"+dirList[i], "Value", "-100000000 0 50000;0 250 0; 250 1000 625;1000 2000 1500;\
                                                                  ...
                                                                  19000 20000 19500;20000 100000000 50000", fetchpath+"\\"+dirList[i]+"_rc", "DATA")
